...
// Helper function to create a theme that combines StyleSheet styles with color config values
// This prevents the web "Invalid value used as weak map key" error by separating
// style objects (processed by StyleSheet.create) from raw color values (kept as-is)
const createTheme = (styles, colorConfig) => {
  const processedStyles = StyleSheet.create(styles);
  return { ...processedStyles, ...colorConfig };
};
...
export const lavenderTheme = createTheme(
  ...
  {
    // Color config properties (not processed by StyleSheet.create)
...
// Baby Blue Theme
export const babyBlueTheme = createTheme(
  {
    ...commonStyles,
    container: {
      ...commonStyles.container,
...
// Fairy Theme
export const fairyTheme = createTheme(
  {
    ...commonStyles,
    container: {
      ...commonStyles.container,
...
// Barbie Theme
export const barbieTheme = createTheme(
  {
    ...commonStyles,
    container: {
      ...commonStyles.container,
